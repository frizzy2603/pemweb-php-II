    ...
    <div class="container">
        <form method="post" action="add_user.php">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" name="birth_place" value="<?= @$_POST['birth_place']; ?>"
                    placeholder="Tempat lahir">
            </div>
            <div class="form-group">
                <label>Tanggal Lahir:</label>
                <input type="date" class="form-control" name="birth_date" value="<?= @$_POST['birth_date']; ?>"
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" name="job_title" value="<?= @$_POST['job_title']; ?>"
